...
namespace Com.Mygame {
	...
	public class MyCharacterController {
		...
		public MyCharacterController(string which_character) {
			...
			if (which_character == "priest") {
				...
				character = Object.Instantiate (Resources.Load ("Devil", typeof(GameObject)), Vector3.zero, Quaternion.identity, null) as GameObject;
				characterType = 1;
			}
	...
	public class CoastController {
		...
		public CoastController(string _to_or_from) {
			...
			if (_to_or_from == "from") {
				coast = Object.Instantiate (Resources.Load ("land", typeof(GameObject)), from_pos, Quaternion.identity, null) as GameObject;
				coast.name = "from";
				to_or_from = 1;
			} else {
				coast = Object.Instantiate (Resources.Load ("land", typeof(GameObject)), to_pos, Quaternion.identity, null) as GameObject;
				coast.name = "to";
				to_or_from = -1;
			}
		}
